//
// This is a Example from EXILE.Altis  inside of File initServer.sqf
// With this, you Can edit your Traders and all Others directly in EDEN
//
...

{
    ...
    _object set3DENAttribute ["enableSimulation", (_x select 3) select 0 ];
  	_object set3DENAttribute ["allowDamage", (_x select 3) select 1 ];
} forEach _objects; 
