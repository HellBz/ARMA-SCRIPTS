...
call ExileClient_object_trader_create_eden;
...
ExileClient_object_trader_create_eden = {
    ...
    _trader = create3DENEntity ["Object", _traderClassName, [0,0,0], true];
    _trader set3DENAttribute ["position", _position ];

    _trader setDir _direction;
    _pitch_bank = _trader call BIS_fnc_getPitchBank;
    _dir = getDir _trader;
    _trader set3DENAttribute ["rotation", [_pitch_bank select 0, _pitch_bank select 1, _dir]];
        
    _trader set3DENAttribute ["ExileTraderType", _traderType ];
    _trader set3DENAttribute ["face", _traderFace];
    _trader set3DENAttribute ["ExileAnimations", _animations ];
